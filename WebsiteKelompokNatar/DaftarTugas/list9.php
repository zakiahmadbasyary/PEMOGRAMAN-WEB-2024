...
?>
        ...
        <div>
            ...
            <p>Pada baris awal akan membuat array asosiatif '$arr' dengan dua pasangan kunci-nilai, yaitu 'name' dengan nilai 'John', dan 'age' dengan nilai '20'. Perulangan 'foreach' digunakan untuk iterasi melalui setiap pasangan kunci-nilai dalam array '$arr'. Dalam setiap iterasi, '$key' berisi kunci saat ini dan '$value' berisi nilai yang sesuai dengan kunci tersebut. 
            Pada setiap iterasi, perintah 'echo' mencetak kunci dan nilai dalam format 'key=value'. Kunci ('$key') dan nilai ('$value') dihubungkan oleh tanda '='. 
            Kode ini mencetak semua pasangan kunci-nilai dari array '$arr' dalam format 'key=value' untuk setiap elemen. Karena kedua pasangan kunci-nilai dicetak berurutan tanpa pemisah tambahan, hasil akhirnya adalah 'name=Johnage=20'. Jika diinginkan pemisah seperti spasi atau baris baru antara hasil cetakan, kita bisa memodifikasi perintah echo.</p>
        </div>
    </div>
</body>
</html>
